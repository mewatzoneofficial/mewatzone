...
import { STAFF_TITLE } from "@/utils/config";
  ...
  return (
    <div className="container py-4">
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
        ...
        <Link href="/staffs" className="btn btn-outline-primary btn-sm me-2">
          ...
          <div className="col-md-6">
            ...
            <input
              ...
              {...register("official_mobile", {
                pattern: {
                  value: /^[0-9]{10,12}$/,
                  message: "Enter a valid official mobile number (10–12 digits).",
                },
              })}
              className="form-control"
            ...
            {errors.official_mobile && (
              <div className="invalid-feedback">
                {errors.official_mobile.message}
              </div>
            )}
          </div>
          ...
          <div className="col-md-6">
            ...
            <div>
              <input
                ...
                {...register("status")}
              />
              <label htmlFor="status-Active" className="form-check-label me-3">
                Active
              </label>
